  ...
  try {
    ...
    const messages = [
      ...
      },
      {
        ...
        message: 'Welcome to AllCardStatus Support! We support Bitcoin (BTC), Ethereum (ETH), Litecoin (LTC), Solana (SOL), and Stablecoins (USDT & USDC). Payments are processed without traditional card processing fees.',
      },
      {
        id: 'msg-03',
        conversationId: convId,
