          ...
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <div className="hidden lg:flex items-center gap-2.5">
              <button
                ...
                title="Search gift cards (⌘K)"
                className="flex items-center gap-2 px-3 py-1.5 rounded-xl border border-slate-200/90 dark:border-slate-800 bg-slate-50/80 dark:bg-slate-800/60 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-all text-xs font-semibold group cursor-pointer"
              >
                <Search className="w-3.5 h-3.5 text-slate-500 group-hover:text-[#2563EB] dark:group-hover:text-blue-400 transition-colors" />
                <span className="hidden xl:inline">Search cards...</span>
                <span className="xl:hidden">Search</span>
                <kbd className="hidden xl:inline-flex items-center px-1.5 py-0.5 text-[10px] font-mono bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded text-slate-400 group-hover:border-[#2563EB]/40 transition-colors">
                  ⌘K
                </kbd>
              </button>
            ...
            <div className="flex lg:hidden items-center gap-1.5 sm:gap-2">
              <button
                ...
                className="w-9 h-9 p-2 inline-flex items-center justify-center rounded-xl text-slate-600 dark:text-slate-300 hover:text-[#2563EB] dark:hover:text-blue-400 hover:bg-slate-100 dark:hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-[#2563EB] transition-colors cursor-pointer"
              >
            ...
            <div>
              ...
              <div className="px-4 pt-3 pb-1">
                <button
                  ...
                  className="w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/60 text-slate-500 dark:text-slate-400 text-xs font-semibold hover:border-[#2563EB] dark:hover:border-blue-500 transition-colors"
                >
