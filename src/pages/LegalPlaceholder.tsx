...
export const LegalPlaceholder: React.FC = () => {
  ...
  const summary = isSecurity
    ? 'AllCardStatus enforces 256-bit TLS 1.3 encryption, OpenSSL verified ciphers, and strict HSTS headers across all transactions.'
    : 'Review the comprehensive operational terms, code redemption protocols, and buyer protections governing AllCardStatus.';
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-6 sm:p-10 shadow-xs space-y-8 text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
          <div className="flex items-center gap-3 p-4 rounded-2xl bg-indigo-50/70 dark:bg-indigo-950/50 border border-indigo-100 dark:border-indigo-800/80 text-indigo-900 dark:text-indigo-200">
            ...
            <div className="text-xs">
              ...
              AllCardStatus operates under verified 256-bit SSL certificate authority validation, automated threat monitoring, and full compliance with GDPR & CCPA digital asset regulations.
            </div>
          </div>
          ...
          {isSecurity ? (
            <>
              <section className="space-y-3">
                ...
                <p>
                  Every request transmitted to AllCardStatus is strictly encrypted over HTTPS. In accordance with modern security best practices, our reverse proxy and server middleware automatically upgrade unencrypted HTTP requests to secure HTTPS and inject the <code className="px-1.5 py-0.5 rounded bg-slate-100 dark:bg-slate-800 text-xs font-mono">Strict-Transport-Security: max-age=63072000; includeSubDomains; preload</code> header.
                </p>
              </section>
            ...
            <>
              <section className="space-y-3">
                ...
                <p>
                  Upon successful payment authorization, AllCardStatus generates authentic digital gift card claim codes. Codes are dispatched electronically to the purchaser's verified delivery email and accessible in the authenticated account dashboard.
                </p>
              </section>
              ...
              <section className="space-y-3">
                ...
                <p>
                  Gift cards purchased through AllCardStatus are valid for direct balance redemption across the respective merchant's authorized digital and physical retail stores. AllCardStatus guarantees 100% authenticity at the time of code issuance.
                </p>
              </section>
              ...
              <section className="space-y-3">
                ...
                <p>
                  Users are responsible for maintaining the confidentiality of their account credentials and delivery inboxes. AllCardStatus will never ask for your account password via email or telephone.
                </p>
              </section>
            </>
          )}
