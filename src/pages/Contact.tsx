    ...
    <PageContainer breadcrumbs={[{ label: 'Contact Support' }]}>
      ...
      <div className="max-w-5xl mx-auto py-2 sm:py-4 space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 items-start">
          ...
          <div className="lg:col-span-7 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-4 sm:p-6 shadow-2xs">
            {isSuccess && ticketDetails ? (
              <div className="py-4 text-center space-y-4 animate-in fade-in zoom-in-95">
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-emerald-100 dark:bg-emerald-950/80 text-emerald-600 dark:text-emerald-400 flex items-center justify-center mx-auto shadow-xs">
                ...
                {/* Ticket Badge */}
                <div className="bg-slate-50 dark:bg-slate-950/80 rounded-xl p-3.5 sm:p-4 border border-slate-200 dark:border-slate-800 max-w-md mx-auto space-y-2.5 text-left">
                  <div className="flex items-center justify-between text-xs text-slate-500 dark:text-slate-400">
                    <span className="font-semibold uppercase tracking-wider text-[11px]">Tracking Reference</span>
                  ...
                  <div className="flex items-center justify-between gap-3 bg-white dark:bg-slate-900 p-2.5 sm:p-3 rounded-xl border border-indigo-100 dark:border-indigo-900/60">
                    <div className="font-mono font-extrabold text-indigo-600 dark:text-indigo-400 text-sm sm:text-base">
                      {ticketDetails.ticketId}
                    </div>
                    <button
                      type="button"
                      onClick={handleCopyTicket}
                      className="px-2.5 py-1 rounded-lg bg-indigo-50 dark:bg-indigo-950 text-indigo-600 dark:text-indigo-300 hover:bg-indigo-100 text-xs font-semibold flex items-center gap-1 transition-colors"
                    >
                  ...
                  <div className="grid grid-cols-2 gap-2 pt-2 text-[11px] text-slate-600 dark:text-slate-400 border-t border-slate-200 dark:border-slate-800">
                    <div>
                      ...
                      <strong className="text-slate-800 dark:text-slate-200 text-xs">{ticketDetails.department}</strong>
                    </div>
                    <div>
                      <span className="text-slate-400 block text-[10px]">Expected Response:</span>
                      <strong className="text-emerald-600 dark:text-emerald-400 text-xs">{ticketDetails.estimatedResponseTime}</strong>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-2.5 pt-2">
                  <a href="mailto:support@allcardstatus.com" className="w-full sm:w-auto">
                    <Button variant="primary" size="md" className="w-full" leftIcon={<Mail className="w-4 h-4" />}>
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="bg-slate-900 text-white rounded-2xl p-4 sm:p-5 space-y-4 shadow-md border border-slate-800">
              ...
              <div className="space-y-3 text-xs sm:text-sm">
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    <div className="text-slate-400 text-[11px]">Official Support Desk</div>
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    <div className="text-slate-400 text-[11px]">Average Response Window</div>
                    <div className="font-semibold text-white text-xs sm:text-sm">Under 15 minutes</div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    ...
                    <div className="font-semibold text-white text-xs sm:text-sm">256-bit TLS 1.3 Encryption</div>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-1 space-y-2">
                <button
                  ...
                  className="w-full py-2.5 px-4 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs flex items-center justify-center gap-2 shadow-sm transition-all cursor-pointer border border-emerald-400/30 active:scale-95"
                >
                ...
                <a
                  ...
                  className="w-full py-2 px-4 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 font-semibold text-xs flex items-center justify-center gap-2 transition-all cursor-pointer"
                >
                  <Mail className="w-4 h-4" />
            ...
            <div className="bg-indigo-50 dark:bg-indigo-950/60 border border-indigo-200/70 dark:border-indigo-800 rounded-2xl p-4 sm:p-5 text-xs text-indigo-950 dark:text-indigo-200 space-y-2.5">
              <div className="font-bold flex items-center gap-1.5 text-indigo-900 dark:text-white text-xs sm:text-sm">
                <HelpCircle className="w-4 h-4 text-indigo-600 dark:text-indigo-400" />
                <span>Instant Self-Service Tools</span>
              </div>
              <p className="text-indigo-800 dark:text-indigo-300 leading-relaxed text-[11px] sm:text-xs">
              ...
              <div className="pt-0.5 flex flex-col gap-1.5">
                <Link
                  to="/validate"
                  className="px-3 py-1.5 rounded-xl bg-white dark:bg-slate-900 border border-indigo-200 dark:border-indigo-800 font-bold text-indigo-600 dark:text-indigo-300 hover:bg-indigo-100 transition-colors flex items-center justify-between text-xs"
                >
