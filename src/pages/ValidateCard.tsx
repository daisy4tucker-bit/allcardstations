...
export const VALIDATE_BRANDS: ValidationBrand[] = [
  {
    ...
    name: 'Airbnb',
    category: 'Travel',
    image: findHomeCardImage('airbnb', 'https://i.pcmag.com/imagery/articles/03VDBodH56HmiGaAHSlH6FH-1.fit_lim.size_1200x630.v1640087360.jpg'),
