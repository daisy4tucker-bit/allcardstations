        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              disabled={isFetching}
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 text-xs font-bold text-slate-900 dark:text-slate-100 hover:text-indigo-600 dark:hover:text-indigo-400 hover:border-indigo-300 dark:hover:border-indigo-800 shadow-2xs transition-all cursor-pointer disabled:opacity-50"
            >
